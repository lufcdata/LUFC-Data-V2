...
-- Ensure newly surfaced people exist as stable entities.
...
-- Venables joined Robson as joint manager from 4 Dec 2000.
-- Raw source remains Terry Venables.
...
set member_role='joint', role_certainty='confirmed',
    provenance_note='Confirmed joint manager alongside Bryan Robson.'
from public.managerial_assignments ma
where map.managerial_assignment_id=ma.managerial_assignment_id
  and ma.match_id=3577
...
select ma.managerial_assignment_id, mp.managerial_person_id, 'joint', 'confirmed',
       'Confirmed joint manager alongside Terry Venables.'
from public.managerial_assignments ma
join public.managerial_people mp on mp.canonical_name='Bryan Robson'
...
update public.managerial_assignment_people map
set member_role='joint', role_certainty='confirmed',
    provenance_note='Confirmed joint caretaker alongside Jon Rudkin.'
from public.managerial_assignments ma
where map.managerial_assignment_id=ma.managerial_assignment_id
  and ma.match_id=4140
  and map.managerial_person_id=(select managerial_person_id from public.managerial_people where canonical_name='Mike Stowell');

insert into public.managerial_assignment_people
  (managerial_assignment_id, managerial_person_id, member_role, role_certainty, provenance_note)
select ma.managerial_assignment_id, mp.managerial_person_id, 'joint', 'confirmed',
       'Confirmed joint caretaker alongside Mike Stowell.'
from public.managerial_assignments ma
join public.managerial_people mp on mp.canonical_name='Jon Rudkin'
...
update public.managerial_assignment_people map
set member_role='joint', role_certainty='confirmed',
    provenance_note='Confirmed member of Rotherham interim management team with Scott Brown and Dan Green.'
from public.managerial_assignments ma
where map.managerial_assignment_id=ma.managerial_assignment_id
  and ma.match_id=4724
...
insert into public.managerial_assignment_people
  (managerial_assignment_id, managerial_person_id, member_role, role_certainty, provenance_note)
select ma.managerial_assignment_id, mp.managerial_person_id, 'joint', 'confirmed',
       'Confirmed member of Rotherham interim management team with Wayne Carlisle.'
from public.managerial_assignments ma
join public.managerial_people mp on mp.canonical_name in ('Scott Brown','Dan Green')
