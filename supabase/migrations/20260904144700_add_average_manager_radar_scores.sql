...
returns table(
 ...
 average_attacking_score integer,
 average_results_score integer,
 average_defensive_score integer,
 average_achievements_score integer,
 average_discipline_score integer,
 average_personnel_score integer,
 average_longevity_score integer
)
...
with league_tiers as (
 ...
 from matches m join manager_spells ms on ms.manager_spell_id=m.manager_spell_id
), base as (
 ...
 select
  round(avg(attacking_score))::int average_attacking_score,
  round(avg(results_score))::int average_results_score,
  round(avg(defensive_score))::int average_defensive_score,
  round(avg(achievements_score))::int average_achievements_score,
  round(avg(discipline_score))::int average_discipline_score,
  round(avg(personnel_score))::int average_personnel_score,
  round(avg(longevity_score))::int average_longevity_score
 from ranked
)
select r.manager_id,r.attacking_score,r.results_score,r.defensive_score,r.achievements_score,r.discipline_score,r.personnel_score,r.longevity_score,
 ...
 a.average_attacking_score,a.average_results_score,a.average_defensive_score,a.average_achievements_score,a.average_discipline_score,a.average_personnel_score,a.average_longevity_score
from ranked r cross join averages a where r.manager_id=p_manager_id;
$function$;
