...
export default function Leaderboard(){
 ...
 useEffect(()=>{
   ...
   supabase.from('opponent_leaderboard').select('*').order('played',{ascending:false}).then(({data,error})=>{
