...
export default function ManagerPerformanceRadar({managerId}:{managerId:number}){
 ...
 return <section className="card manager-radar-card"><div className="manager-radar-head"><div><span className="section-kicker">Manager profile</span><h2>Manager Performance</h2></div><div className="manager-radar-head-meta"><span className="manager-radar-scale">0–100</span><span className="manager-radar-average-key"><i/>Leeds manager average</span></div></div>
  <div className="manager-radar-layout"><svg className="manager-radar-svg" viewBox="0 0 410 330" role="img" aria-label="Manager performance radar chart with Leeds manager average comparison">
