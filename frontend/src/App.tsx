...
type Page='matches'|'match-centre'|'goals'|'red-cards'|'penalties'|'own-goals'|'stat-pack'|'players'|'player-profile'|'managers'|'manager-profile'|'opponents'|'test-a1'|'player-admin';
function App() {
